...
add wave -noupdate -radix unsigned /tb_adder_unsigned/x1
add wave -noupdate -radix unsigned /tb_adder_unsigned/x2
add wave -noupdate -radix unsigned /tb_adder_unsigned/sum
...
WaveRestoreCursors {{Cursor 1} {28619500000 ps} 0}
